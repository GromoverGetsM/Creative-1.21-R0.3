...
import ru.rstudios.creative.coding.actions.*;
...
import ru.rstudios.creative.coding.starters.uncommon.Cycle;
import ru.rstudios.creative.coding.starters.uncommon.Function;
...
public class CodeHandler {
    ...
    public void saveDynamicVars() {
        ...
        File file = new File(Bukkit.getWorldContainer() + File.separator + plot.getDev().world().getName() + File.separator + "dynamicVars.txt");
