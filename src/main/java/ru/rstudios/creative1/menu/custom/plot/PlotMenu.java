...
public class PlotMenu extends ProtectedMenu {
    ...
    public PlotMenu (User user) {
        ...
        this.closeable = new SwitchItem("menus.plot.items.closeable.name", "menus.plot.items.closeable.lore", List.of("true", "false"), "menus.plot.items.closeable.states.", List.of(Material.LIME_CONCRETE_POWDER, Material.RED_CONCRETE_POWDER));
