...
public class EntityAction extends CodingCategoriesMenu {
    ...
    public void fillItemsPage(User user) {
        List<ActionCategory> actions = ActionCategory.getActionsByCategory(Development.BlockTypes.ENTITY_ACTION, this.selectedCategory);
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        if (event.getCurrentItem() != null) {
            if (selectedCategory == null) {
                ...
                ActionCategory category = ActionCategory.get(event.getCurrentItem().getType(), Development.BlockTypes.ENTITY_ACTION, selectedCategory);
