...
public class PlayerAction extends CodingCategoriesMenu {
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        if (event.getCurrentItem() != null) {
            ...
            if (category != null) {
                CodingMultipagesMenu menu = new PlayerAction.Actions(user, category, this.sign);
    ...
    static class Actions extends CodingMultipagesMenu {
        ...
        public Actions(User user, MenuCategory category, Block sign) {
            super(LocaleManages.getLocaleMessage(user.getLocale(), "coding.player_action", false, ""), user);
        ...
        public List<ItemStack> getMenuElements() {
            List<ActionCategory> actions = ActionCategory.getActionsByCategory(Development.BlockTypes.PLAYER_ACTION, this.category);
        ...
        public void onMenuElementClick(InventoryClickEvent event) {
            ActionCategory category = ActionCategory.get(event.getCurrentItem().getType(), Development.BlockTypes.PLAYER_ACTION, this.category);
