...
public class IfPlayer extends CodingCategoriesMenu {
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        if (event.getCurrentItem() != null) {
            ...
            if (category != null) {
                CodingMultipagesMenu menu = new IfPlayer.Actions(user, category, this.sign);
    ...
    static class Actions extends CodingMultipagesMenu {
        ...
        public Actions(User user, MenuCategory category, Block sign) {
            super(LocaleManages.getLocaleMessage(user.getLocale(), "coding.if_player", false, ""), user);
        ...
        public List<ItemStack> getMenuElements() {
            List<ActionCategory> actions = ActionCategory.getActionsByCategory(Development.BlockTypes.IF_PLAYER, this.category);
        ...
        public void onMenuElementClick(InventoryClickEvent event) {
            ActionCategory category = ActionCategory.get(event.getCurrentItem().getType(), Development.BlockTypes.IF_PLAYER, this.category);
