...
public class ActionVar extends CodingCategoriesMenu {
    public ActionVar(User user) {
        super(LocaleManages.getLocaleMessage(user.getLocale(), "coding.action_var", false, ""), (byte) 6);
    }

    @Override
    public void fillItems(User user) {
        List<MenuCategory> categories = new LinkedList<>(ActionCategory.getMenuCategories(Development.BlockTypes.ACTION_VAR));
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        if (event.getCurrentItem() != null) {
            ...
            if (category != null) {
                CodingMultipagesMenu menu = new ActionVar.Actions(user, category, this.sign);
    ...
    static class Actions extends CodingMultipagesMenu {
        ...
        public Actions(User user, MenuCategory category, Block sign) {
            super(LocaleManages.getLocaleMessage(user.getLocale(), "coding.action_var", false, ""), user);
        ...
        public List<ItemStack> getMenuElements() {
            List<ActionCategory> actions = ActionCategory.getActionsByCategory(Development.BlockTypes.ACTION_VAR, this.category);
        ...
        public void onMenuElementClick(InventoryClickEvent event) {
            ActionCategory category = ActionCategory.get(event.getCurrentItem().getType(), Development.BlockTypes.ACTION_VAR, this.category);
