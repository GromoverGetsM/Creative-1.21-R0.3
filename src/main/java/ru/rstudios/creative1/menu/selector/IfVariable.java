...
public class IfVariable extends CodingCategoriesMenu {
    public IfVariable(User user) {
        super(LocaleManages.getLocaleMessage(user.getLocale(), "coding.if_variable", false, ""), (byte) 6);
    }
