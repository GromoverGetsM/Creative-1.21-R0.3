...
public class PlayerEvent extends CodingCategoriesMenu {
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        if (event.getCurrentItem() != null) {
            ...
            if (category != null) {
                CodingMultipagesMenu menu = new PlayerEvent.Actions(user, category, this.sign);
    ...
    static class Actions extends CodingMultipagesMenu {
        ...
        public Actions(User user, MenuCategory category, Block sign) {
            super(LocaleManages.getLocaleMessage(user.getLocale(), "coding.player_event", false, ""), user);
        ...
        public List<ItemStack> getMenuElements() {
            List<StarterCategory> actions = StarterCategory.getStartersByCategory(Development.BlockTypes.PLAYER_EVENT, this.category);
        ...
        public void onMenuElementClick(InventoryClickEvent event) {
            StarterCategory category = StarterCategory.get(event.getCurrentItem().getType(), Development.BlockTypes.PLAYER_EVENT, this.category);
