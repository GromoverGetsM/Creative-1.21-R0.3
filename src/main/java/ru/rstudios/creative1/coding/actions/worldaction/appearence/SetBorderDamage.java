...
public class SetBorderDamage extends Action {
    @Override
    public void execute(GameEvent event, List<Entity> selection) {
        ...
        for (Entity entity : selection) {
            ...
            double damage = chest.parseNumberPlus(chest.getOriginalContents()[15], 0, event, entity);
    ...
    public ActionCategory getCategory() {
        return ActionCategory.SET_BORDER_DAMAGE;
    }
}
